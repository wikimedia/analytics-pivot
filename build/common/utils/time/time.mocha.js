...
describe('Time', function () {
    ...
    var TZ_KATHMANDU = new chronoshift_1.Timezone("Asia/Kathmandu");
    var TZ_TIJUANA = new chronoshift_1.Timezone("America/Tijuana");
    var TZ_Kiritimati = new chronoshift_1.Timezone("Pacific/Kiritimati");
