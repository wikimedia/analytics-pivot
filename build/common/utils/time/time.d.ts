...
export declare function getEndWallTimeInclusive(exclusiveEnd: Date, timezone: Timezone): any;
...
export declare function getWallTimeDay(date: Date, timezone: Timezone): any;
