...
export declare class SplitCombine implements Instance<SplitCombineValue, SplitCombineJS> {
    static SORT_ON_DIMENSION_PLACEHOLDER: string;
    ...
    toKey(): string;
    getNormalizedSortAction(dimensions: List<Dimension>): SortAction;
    changeBucketAction(bucketAction: Action): SplitCombine;
    changeSortAction(sortAction: SortAction): SplitCombine;
    changeSortActionFromNormalized(sortAction: SortAction, dimensions: List<Dimension>): SplitCombine;
