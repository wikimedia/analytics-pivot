...
describe('SettingsMenu', function () {
    it('adds the correct class', function () {
        ...
        var renderedComponent = TestUtils.renderIntoDocument(React.createElement(settings_menu_1.SettingsMenu, {dataCube: mocks_1.DataCubeMock.twitter(), onClose: null, openOn: openOn, changeTimezone: function () { }, timezone: chronoshift_1.Timezone.UTC, stateful: true}));
