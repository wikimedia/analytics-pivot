...
var SegmentActionButtons = (function (_super) {
    ...
    SegmentActionButtons.prototype.render = function () {
        ...
        return React.createElement("div", {className: "segment-action-buttons"}, 
            ...
            disableMoreMenu ? null : React.createElement(button_1.Button, {type: "secondary", className: "mini", onClick: this.onMore.bind(this), svg: require('../../icons/full-more-mini.svg'), active: Boolean(moreMenuOpenOn)}), 
            this.renderMoreMenu());
    };
