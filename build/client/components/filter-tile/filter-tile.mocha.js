...
describe('FilterTile', function () {
    ...
    it('adds the correct class', function () {
        var renderedComponent = TestUtils.renderIntoDocument(React.createElement(FilterTile, {clicker: null, essence: mocks_1.EssenceMock.wikiTotals(), timekeeper: mocks_1.TimekeeperMock.fixed(), menuStage: null}));
