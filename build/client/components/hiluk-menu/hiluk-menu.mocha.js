...
describe.skip('HilukMenu', function () {
    it('adds the correct class', function () {
        ...
        var renderedComponent = TestUtils.renderIntoDocument(React.createElement(hiluk_menu_1.HilukMenu, {essence: mocks_1.EssenceMock.wikiTotals(), timekeeper: mocks_1.TimekeeperMock.fixed(), onClose: null, openOn: openOn, getUrlPrefix: function () { return 'http://stackoverflow.com/'; }, openRawDataModal: null}));
