...
describe('LinkHeaderBar', function () {
    it('adds the correct class', function () {
        var renderedComponent = TestUtils.renderIntoDocument(React.createElement(link_header_bar_1.LinkHeaderBar, {title: "Test Link Bar", onNavClick: null, onExploreClick: null, stateful: true}));
