...
describe('CubeHeaderBar', function () {
    it('adds the correct class', function () {
        var renderedComponent = TestUtils.renderIntoDocument(React.createElement(cube_header_bar_1.CubeHeaderBar, {clicker: null, essence: mocks_1.EssenceMock.wikiTotals(), timekeeper: mocks_1.TimekeeperMock.fixed(), onNavClick: null, stateful: true}));
