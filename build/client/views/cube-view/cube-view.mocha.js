...
describe('CubeView', function () {
    ...
    it('adds the correct class', function () {
        ...
        var renderedComponent = TestUtils.renderIntoDocument(React.createElement(CubeView, {hash: null, timekeeper: mocks_1.TimekeeperMock.fixed(), dataCube: mocks_1.DataCubeMock.wiki(), updateViewHash: updateViewHash}));
    ...
    it('remembers measure mode toggle click', function () {
        ...
        var initialCubeView = TestUtils.renderIntoDocument(React.createElement(CubeView, {hash: null, timekeeper: mocks_1.TimekeeperMock.fixed(), dataCube: mocks_1.DataCubeMock.wiki(), updateViewHash: updateViewHash}));
        ...
        var wikiCubeView = TestUtils.renderIntoDocument(React.createElement(CubeView, {hash: null, timekeeper: mocks_1.TimekeeperMock.fixed(), dataCube: mocks_1.DataCubeMock.wiki(), updateViewHash: updateViewHash}));
        ...
        var wikiCubeView2 = TestUtils.renderIntoDocument(React.createElement(CubeView, {hash: null, timekeeper: mocks_1.TimekeeperMock.fixed(), dataCube: mocks_1.DataCubeMock.wiki(), updateViewHash: updateViewHash}));
