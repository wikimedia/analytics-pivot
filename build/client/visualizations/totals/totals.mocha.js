...
describe.skip('Totals', function () {
    it('adds the correct class', function () {
        var renderedComponent = TestUtils.renderIntoDocument(React.createElement(totals_1.Totals, {clicker: null, essence: null, timekeeper: mocks_1.TimekeeperMock.fixed(), stage: null}));
